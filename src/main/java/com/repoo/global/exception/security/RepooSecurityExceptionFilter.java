...
public class RepooSecurityExceptionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        } catch (RepooSecurityException e) {
    ...
    private void handleSpaceSecurityException(HttpServletResponse response, RepooSecurityException e) throws IOException {
